    ...
    public class FashionData
    {
        ...
        **/
        public string ToXml()
        {
            ...
            if (0 == m_values.Count)
            {
                throw new Exception("FashionData数据为空!");
            }
            ...
            foreach (KeyValuePair<string, object> pair in m_values)
            {
                ...
                {
                    throw new Exception("FashionData字段数据类型错误!");
                }
            }
            xml += "</xml>";
            return xml;
        ...
        */
        public SortedDictionary<string, object> FromXml(string xml)
        {
            ...
            {
                throw new Exception("将空的xml串转换为FashionData不合法!");
            }
        ...
        */
        public bool CheckSign()
        {
            ...
            if (!IsSet("sign"))
            {
                throw new Exception("FashionData签名存在但不合法!");
            }
            //如果设置了签名但是签名为空，则抛异常
            ...
            throw new Exception("FashionData签名验证错误!");
        }
