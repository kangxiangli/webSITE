...
//  <copyright file="HostCryptoHubPipelineModule.cs" company="优维拉软件设计工作室">
...
using Whiskey.Web.Http.Internal;
using Whiskey.Web.Properties;


namespace Whiskey.Web.SignalR.Security
{
    /// <summary>
    /// 服务端Hub数据通信加密解密中间模块
    /// </summary>
