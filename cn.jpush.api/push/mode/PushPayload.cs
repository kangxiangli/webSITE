...
namespace Whiskey.jpush.api.push.mode
{
    public class PushPayload
    {
        ...
        public Notification getNotificationAll(string alert, string title, bool contentToTitle = false, string Flag = null)
        {
            Notification notification = new Notification(true);
            notification.IosNotification.setAlert(contentToTitle ? title : alert).AddExtra("title", title).AddExtra("content", alert).setSound("sound");
            notification.AndroidNotification.setAlert(alert).setTitle(title);
            notification.WinphoneNotification.setAlert(alert).setTitle(title);

            if (!string.IsNullOrEmpty(Flag))
            {
                notification.IosNotification.AddExtra("Flag", Flag);
                notification.AndroidNotification.AddExtra("Flag", Flag);
                notification.WinphoneNotification.AddExtra("Flag", Flag);
            }
