...
namespace Whiskey.ZeroStore.ERP.Models
{
    ...
    public class MemberCollocation:EntityBase<int>
    {
        ...
        [Display(Name = "是否用于搭配方案")]
        public bool IsCollocationPlan { get; set; }
        ...
        public virtual ICollection<ColloCalendar> ColloCalendars { get; set; }

        public virtual ICollection<RecommendMemberCollocation> RecommendMembers { get; set; }
