...
{
    public class Mission : EntityBase<int>
    {
        public Mission()
        {
            Categorys = new List<Category>();
            MissionItems = new List<MissionItem>();
            MemberColls = new List<MemberCollocation>();
        }

        [Display(Name = "会员")]
        public virtual int MemberId { get; set; }

        public virtual int MissionCommentId { get; set; }
        ...
        public virtual ProductAttribute Situation { get; set; }

        [ForeignKey("StyleId")]
        public virtual ProductAttribute Style { get; set; }
        ...
        public virtual ICollection<MemberCollocation> MemberColls { get; set; }
    }
}
