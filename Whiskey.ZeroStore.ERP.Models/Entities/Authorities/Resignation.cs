...
{
    public class Resignation : EntityBase<int>
    {
        [DisplayName("离职人")]
        ...
        public virtual Administrator ResignationModel { get; set; }
        [ForeignKey("HandoverManId")]
        public virtual Administrator HandoverMan { get; set; }
