...
{
    public class GallerySeedAction : ISeedAction
    {
        /// <summary>
        /// 获取 操作排序，数值越小越先执行
        /// </summary>
        ...
        public void Action(DbContext context)
        {
            ...
            #region 初始化图片属性
            ////GalleryAttribute实体
            List<GalleryAttribute> gallerycategorys = new List<GalleryAttribute>()
            {
                new GalleryAttribute(){ParentId=null,AttributeName="搭配灵感图",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,Children=new List<GalleryAttribute> {
                    new GalleryAttribute{AttributeName="优雅",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,Children=new List<GalleryAttribute>{
                        //new GalleryAttribute{AttributeName="格子",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        //new GalleryAttribute{AttributeName="条纹",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        //new GalleryAttribute{AttributeName="豹纹",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        //new GalleryAttribute{AttributeName="花朵",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                    }},
                    new GalleryAttribute{AttributeName="干练",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                    new GalleryAttribute{AttributeName="自然",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                    new GalleryAttribute{AttributeName="个性",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                }},
                new GalleryAttribute(){ParentId=null,AttributeName="包类",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,Children=new List<GalleryAttribute>{
                        new GalleryAttribute{AttributeName="颜色",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,Children=new List<GalleryAttribute>{
                            //new GalleryAttribute{AttributeName="黑色",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                            //new GalleryAttribute{AttributeName="白色",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                            //new GalleryAttribute{AttributeName="金色",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                            //new GalleryAttribute{AttributeName="银色",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        }},
                        new GalleryAttribute{AttributeName="图案",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        new GalleryAttribute{AttributeName="大小",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        new GalleryAttribute{AttributeName="款式",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                        new GalleryAttribute{AttributeName="风格",Description="",AttributeLevel=0,Sequence=0, OperatorId=1},
                    }},
                new GalleryAttribute(){ParentId=null,AttributeName="鞋类",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,},
                new GalleryAttribute(){ParentId=null,AttributeName="丝巾类",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,},
                new GalleryAttribute(){ParentId=null,AttributeName="腰带",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,},
                new GalleryAttribute(){ParentId=null,AttributeName="帽子",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,},
                new GalleryAttribute(){ParentId=null,AttributeName="饰品",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,},
                new GalleryAttribute(){ParentId=null,AttributeName="背景类",Description="",AttributeLevel=0,Sequence=0, OperatorId=1,},
            };
            context.Set<GalleryAttribute>().AddOrUpdate(gallerycategorys.ToArray());
