...
namespace Whiskey.Core.Data
{
    ...
    public interface IRepository<TEntity, TKey> : IDependency where TEntity : EntityBase<TKey>
    {
        ...
        OperationResult Insert(ICollection<TEntity> entities,
        ...
        OperationResult Update(ICollection<TEntity> entity);

        OperationResult Update(ICollection<TEntity> entity, Action<TEntity> checkAction = null);
        ...
        /// <returns>查询数据集</returns>
        IQueryable<TEntity> Includes(params string[] paths);
        ...
        /// <returns></returns>
        OperationResult InsertBulk(IEnumerable<TEntity> entities, Action<TEntity> updateAction = null);
        /// <summary>
        /// 批量更新，有导航属性时禁止使用
        /// </summary>
        /// <param name="updateAction"></param>
        /// <returns></returns>
        OperationResult UpdateBulk(IEnumerable<TEntity> entities, Action<TEntity> updateAction = null);
        ...
        /// <returns></returns>
        OperationResult DeleteBulk(IEnumerable<TEntity> entities);
