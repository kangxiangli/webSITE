        ...
        defaults = {
            ...
            callbacks: {
                ...
                loadingError: function($message, xhr) {
                    $message.html('数据加载失败,请尝试刷新页面重新加载。');
                },
                ...
                renderData: function (data, dataType) {
                    ...
                    if (typeof (data) == "object") {
                        if (data.total == 0) {
                            $('.gallery-container').waterfall('pause', function () {
                               // $('#waterfall-message').html("什么都没有了...");
                            });
                        }
                    }
