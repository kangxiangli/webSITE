...
namespace Whiskey.ZeroStore.ERP.Website.Extensions.Web
{
    public static class EntityContract
    {
        ...
        public static ISmsContract _SmsContract { get; set; }
        public static IOrderFoodContract _OrderFoodContract { get; set; }
        public static void InitContract()
        {
            ...
            _SmsContract = DependencyResolver.Current.GetService<ISmsContract>();
            _OrderFoodContract = DependencyResolver.Current.GetService<IOrderFoodContract>();
        }
    }
}