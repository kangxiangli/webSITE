...
namespace Whiskey.ZeroStore.ERP.Website.Areas.Stores.Controllers
{
    ...
    public class StoreTypeController : BaseController
    {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Create(StoreTypeDto dto)
        {
        ...
        public ActionResult List(int? storeId)
        {
            ...
            Expression<Func<StoreType, bool>> predicate = FilterHelper.GetExpression<StoreType>(request.FilterGroup);
            var count = 0;

            var list = _storeTypeContract.Entities.Where<StoreType, int>(predicate, request.PageCondition, out count)
            .Select(s => new
            {
                s.Id,
                s.TypeName,
