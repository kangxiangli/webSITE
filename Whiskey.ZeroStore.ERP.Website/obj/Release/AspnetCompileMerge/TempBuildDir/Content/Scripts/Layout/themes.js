...
(function () {
    ...
    var demo_themes = [
      { name: 'default', title: '默认', img: '/content/images/common/themes/default.png' },
      { name: 'asphalt', title: '沥青', img: '/content/images/common/themes/asphalt.png' },
      { name: 'purple-hills', title: '雅紫', img: '/content/images/common/themes/purple-hills.png' },
      { name: 'adminflare', title: '宝蓝', img: '/content/images/common/themes/adminflare.png' },
      { name: 'dust', title: '黄橙', img: '/content/images/common/themes/dust.png' },
      { name: 'frost', title: '海蓝', img: '/content/images/common/themes/frost.png' },
      { name: 'fresh', title: '草绿', img: '/content/images/common/themes/fresh.png' },
      { name: 'silver', title: '银灰', img: '/content/images/common/themes/silver.png' },
      { name: 'clean', title: '藏蓝', img: '/content/images/common/themes/clean.png' },
      { name: 'white', title: '玉白', img: '/content/images/common/themes/white.png' }
    ];
